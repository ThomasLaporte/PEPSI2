...
<section class="catalogue_products wow fadeInUp">
    <article class="catalogue_products_title back">
        ...
        <ul>
            ...
            <li>Catégorie : <a href="../CategArticle/showArticleCateg.php?categ=<?php echo $currentProduct['article_category_code']; ?>"><?php echo $lstFunctions->getProductCategByID($currentProduct['article_category_code'])[0]['name']; ?></a></li>
        </ul>
