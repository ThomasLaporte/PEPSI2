...
<html lang="fr">
  ...
  <body> -->
    ...
    if(isset($_POST['productName']) &&  isset($_POST['productQuantity']))
    {
       ...
       if($lstFunctions->addProduct($_POST['productName'], $_POST['productRef'], $_POST['productQuantity'],$_POST['productWeight'],$_POST['productSize'],$_POST['productPicture'],$_POST['productManufacturer'], $_POST['productCateg'])){ // $_POST['productCateg']
