...
class ProductCategs {
   ...
   {
     $sql = "SELECT code, name, description FROM article_category";
   ...
   {
     $sql = "SELECT code, name, description FROM article_category WHERE language_idlanguage = :idLanguage";
     $array = array(
   ...
   {
     $sql = "INSERT INTO article_category (name, code, language_idlanguage, description) VALUES (:name, :code, :idLanguage, :desc)";
