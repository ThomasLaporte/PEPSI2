...
$title_page = 'Spectasonic - Catégories';
include '../header.php';
...
<h1 class="wow fadeIn">Liste des catégories</h1>
<?php foreach ($lstFunctions->getProductsCategsByLang('1') as $categ) { ?>
  <section class="catalogue_products wow fadeInUp">
      ...
      <article class="article_products_display">
          <a href="showCateg.php?categ=<?php echo $categ['code']; ?>" class="article_img_link"><img src="http://lorempixel.com/output/city-q-c-250-175-4.jpg" /></a>
          <div class="article_products_display_details">
              ...
              <a href="showCateg.php?categ=<?php echo $categ['code']; ?>"><button>Voir</button></a>
          </div>
      </article>
      </div>
  </section>
